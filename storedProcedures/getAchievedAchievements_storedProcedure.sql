...
-- =============================================
IF OBJECTPROPERTY(object_id('dbo.getAchievedAchievements'), N'IsProcedure') = 1
DROP PROCEDURE [dbo].[getAchievedAchievements]
GO


CREATE PROCEDURE getAchievedAchievements
	@fbID BIGINT
AS
BEGIN
